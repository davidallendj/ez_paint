...
namespace Collision {
	...
	bool PixelPerfectTest(const sf::Shape& Shape1, const sf::Sprite& Shape2, sf::Uint8 AlphaLimit = 0);
	...
	bool CircleTest(const sf::CircleShape& Object1, const sf::FloatRect& Object2);		// added overload
